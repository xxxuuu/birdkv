...
func (e *LabClientEnd) Call(svcMeth string, args interface{}, reply interface{}) bool {
	req := reqMsg{}
...
type Network struct {
	...
	ends           map[interface{}]net.ClientEnd // ends, by name
...
func MakeNetwork() *Network {
	rn := &Network{}
	rn.reliable = true
	rn.ends = map[interface{}]net.ClientEnd{}
...
func (rn *Network) MakeEnd(endname interface{}) net.ClientEnd {
	rn.mu.Lock()
	defer rn.mu.Unlock()
